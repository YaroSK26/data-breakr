  ...
  return (
    <section
      style={{
        ...
        alignItems: "center",
        background:
          "linear-gradient(160deg, #0f1f4d 0%, #1e3a8a 45%, #2563eb 100%)",
        color: "white",
    ...
    >
      ...
      >
        <div style={{ flex: "1 1 420px", minWidth: 280 }}>
          ...
          >
            Otvorená mapa hustoty firiem a živnostníkov podľa okresu a odvetvia
            - postavená na verejnom registri, aktualizovaná priamo z primárneho
            zdroja.
          </p>
