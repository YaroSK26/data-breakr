...
export const LEGAL_FORMS: { kod: string; nazov: string }[] = [
  ...
  { kod: '001', nazov: 'Samostatne podnikajúca fyzická osoba' },
  { kod: '102', nazov: 'Podnikateľ - fyzická osoba zapísaný v obchodnom registri' },
  { kod: '111', nazov: 'Verejná obchodná spoločnosť' },
  { kod: '301', nazov: 'Štátny podnik' },
  { kod: '005', nazov: 'Podnik zahraničnej osoby (organizačná zložka)' },
  { kod: '995', nazov: 'Nešpecifikovaná právna forma' },
